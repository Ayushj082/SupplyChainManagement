...
contract Tracking{
    ...
    uint256 deliveryTime, uint256 distance, uint256 price);
    ...
    function completeShipment(address _sender, address _receiver, uint256 _index) public{
        ...
        require(shipment.receiver == _receiver, "Invalid Receiver");
        require(shipment.status == ShipmentStatus.IN_TRANSIT, "System Not in transit");
    ...
    function getShipment(address _sender, uint256 _index) public view returns (address, address, uint256,
     uint256, uint256, uint256, ShipmentStatus, bool) {
